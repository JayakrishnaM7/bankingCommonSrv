...
@Component
public class CustomerLstCBSRestUtil extends RestUtil{
	...
	private CustomerLstResponse response;
	...
	protected void parseJsonResponse(ResponseEntity response) {
		...
		setResponse(JsonUtil.convertJsontoJava(jsonResp,CustomerLstResponse.class));
	}




	public CustomerLstResponse getResponse() {
		return response;
	}

	public void setResponse(CustomerLstResponse response) {
	...
	public URI getRestWsUrlWithParam(String customerId)  {
        ...
        .queryParam("statuses", "CUSTOMER_STATUS_ACTIVE")
